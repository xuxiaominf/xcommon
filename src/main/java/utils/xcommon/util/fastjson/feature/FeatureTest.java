package utils.xcommon.util.fastjson.feature;
...
//        showJsonBySelf();
     ...
     */
    private static void showQuoteFieldNames() {
        System.out.println(JSON.toJSONString(word));
        System.out.println(JSON.toJSONString(word, SerializerFeature.QuoteFieldNames));
    }
